...
enum HealthConstants {
    ...
    static let WALKING_DOUBLE_SUPPORT_PERCENTAGE = "WALKING_DOUBLE_SUPPORT_PERCENTAGE"
    static let WALKING_STEP_LENGTH = "WALKING_STEP_LENGTH"
    static let WALKING_ASYMMETRY_PERCENTAGE = "WALKING_ASYMMETRY_PERCENTAGE"
    static let APPLE_WALKING_STEADINESS = "APPLE_WALKING_STEADINESS"
    static let STAIR_ASCENT_SPEED = "STAIR_ASCENT_SPEED"
    static let STAIR_DESCENT_SPEED = "STAIR_DESCENT_SPEED"
    static let SIX_MINUTE_WALK_TEST_DISTANCE = "SIX_MINUTE_WALK_TEST_DISTANCE"
    static let RUNNING_POWER = "RUNNING_POWER"
    static let RUNNING_SPEED = "RUNNING_SPEED"
    static let RUNNING_STRIDE_LENGTH = "RUNNING_STRIDE_LENGTH"
    static let RUNNING_VERTICAL_OSCILLATION = "RUNNING_VERTICAL_OSCILLATION"
    static let RUNNING_GROUND_CONTACT_TIME = "RUNNING_GROUND_CONTACT_TIME"
    static let HEART_RATE_RECOVERY_ONE_MINUTE = "HEART_RATE_RECOVERY_ONE_MINUTE"
    static let PHYSICAL_EFFORT = "PHYSICAL_EFFORT"
    static let ENVIRONMENTAL_AUDIO_EXPOSURE = "ENVIRONMENTAL_AUDIO_EXPOSURE"
    static let HEADPHONE_AUDIO_EXPOSURE = "HEADPHONE_AUDIO_EXPOSURE"
    static let NUMBER_OF_TIMES_FALLEN = "NUMBER_OF_TIMES_FALLEN"
    static let BASAL_BODY_TEMPERATURE = "BASAL_BODY_TEMPERATURE"
    static let PEAK_EXPIRATORY_FLOW = "PEAK_EXPIRATORY_FLOW"
    static let FORCED_VITAL_CAPACITY = "FORCED_VITAL_CAPACITY"
    static let INHALER_USAGE = "INHALER_USAGE"
    static let BLOOD_ALCOHOL_CONTENT = "BLOOD_ALCOHOL_CONTENT"
    static let NUMBER_OF_ALCOHOLIC_BEVERAGES = "NUMBER_OF_ALCOHOLIC_BEVERAGES"
    static let PUSH_COUNT = "PUSH_COUNT"
    static let SWIMMING_STROKE_COUNT = "SWIMMING_STROKE_COUNT"
    static let DISTANCE_WHEELCHAIR = "DISTANCE_WHEELCHAIR"
    static let DISTANCE_DOWNHILL_SNOW_SPORTS = "DISTANCE_DOWNHILL_SNOW_SPORTS"
    static let DISTANCE_CROSS_COUNTRY_SKIING = "DISTANCE_CROSS_COUNTRY_SKIING"
    static let DISTANCE_PADDLE_SPORTS = "DISTANCE_PADDLE_SPORTS"
    static let DISTANCE_ROWING = "DISTANCE_ROWING"
    static let DISTANCE_SKATING_SPORTS = "DISTANCE_SKATING_SPORTS"
    static let CYCLING_CADENCE = "CYCLING_CADENCE"
    static let CYCLING_POWER = "CYCLING_POWER"
    static let CYCLING_SPEED = "CYCLING_SPEED"
    static let CYCLING_FUNCTIONAL_THRESHOLD_POWER = "CYCLING_FUNCTIONAL_THRESHOLD_POWER"
    static let CROSS_COUNTRY_SKIING_SPEED = "CROSS_COUNTRY_SKIING_SPEED"
    static let PADDLE_SPORTS_SPEED = "PADDLE_SPORTS_SPEED"
    static let ROWING_SPEED = "ROWING_SPEED"
    static let ENVIRONMENTAL_SOUND_REDUCTION = "ENVIRONMENTAL_SOUND_REDUCTION"
    static let WORKOUT_EFFORT_SCORE = "WORKOUT_EFFORT_SCORE"
    static let ESTIMATED_WORKOUT_EFFORT_SCORE = "ESTIMATED_WORKOUT_EFFORT_SCORE"
    static let APPLE_SLEEPING_BREATHING_DISTURBANCES = "APPLE_SLEEPING_BREATHING_DISTURBANCES"
    ...
    static let LITER_PER_MINUTE = "LITER_PER_MINUTE"
    static let KILOCALORIE_PER_HOUR_KILOGRAM = "KILOCALORIE_PER_HOUR_KILOGRAM"
    static let COUNT_PER_MINUTE = "COUNT_PER_MINUTE"
    static let APPLE_EFFORT_SCORE = "APPLE_EFFORT_SCORE"
